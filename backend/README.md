...
## Project Structure
    ...
    ├── testapiautosetting_125907  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125907`
...
2. Clone this repo and `cd testapiautosetting_125907`
